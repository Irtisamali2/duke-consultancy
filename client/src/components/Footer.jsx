  ...
  return (
    <footer className="w-full bg-gradient-to-b from-white to-[#B3E0EC] py-8 sm:py-10 md:py-12">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        {/* Services and Company section - 2 columns on mobile/tablet, 3 columns on desktop */}
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 md:gap-12">
          <div>
            <h3 className="font-bold text-gray-900 mb-3 sm:mb-4 md:mb-4 text-sm sm:text-base">Services</h3>
          ...
          <div>
            <h3 className="font-bold text-gray-900 mb-3 sm:mb-4 md:mb-4 text-sm sm:text-base">Company</h3>
            <ul className="space-y-2 sm:space-y-2.5 md:space-y-3 text-gray-800 text-xs sm:text-sm md:text-sm">
