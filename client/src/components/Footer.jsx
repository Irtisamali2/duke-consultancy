...
export const Footer = () => {
  ...
  const fetchSocialLinks = async () => {
    try {
      ...
      if (data.success && data.socialLinks.length > 0) {
  ...
  const getSocialIcon = (iconClass) => {
    ...
    return icons[iconClass.toLowerCase()] || icons.facebook;
  };
  ...
  const renderSocialLinks = () => {
    if (socialLinks.length > 0) {
      return socialLinks.map((link) => (
        <a 
          ...
          className="w-10 h-10 md:w-11 md:h-11 rounded-full bg-[#00A6CE] flex items-center justify-center hover:bg-[#0090B5] transition-colors"
        >
          <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            {getSocialIcon(link.icon_class)}
          </svg>
        </a>
      ));
    }
    ...
    return (
      <>
        <a href="#" className="w-10 h-10 md:w-11 md:h-11 rounded-full bg-[#00A6CE] flex items-center justify-center hover:bg-[#0090B5] transition-colors">
          <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="w-full bg-gradient-to-b from-white to-[#B3E0EC] py-8 sm:py-10 md:py-12">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="lg:hidden">
          ...
          <div className="mb-8 sm:mb-10">
            <div className="space-y-4 sm:space-y-5">
              ...
              />
              <p className="text-gray-800 text-sm md:text-base leading-relaxed max-w-xs md:max-w-sm">
          ...
          {/* Services and Company - 2 columns on mobile/tablet */}
          <div className="grid grid-cols-2 gap-8 sm:gap-10 md:gap-12">
            <div>
              ...
              <ul className="space-y-2 sm:space-y-2.5 md:space-y-3 text-gray-800 text-xs sm:text-sm md:text-sm">
        ...
        <div className="hidden lg:grid lg:grid-cols-3 lg:gap-16">
          ...
          {/* Column 2: Services */}
          <div>
            <h3 className="font-bold text-gray-900 mb-4 text-base">Services</h3>
