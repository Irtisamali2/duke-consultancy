...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="w-full py-16 lg:py-20 bg-gradient-to-b from-[#37AFCD]/40 to-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-[#00A6CE] text-sm font-medium">Rated #1 choice for job searching</span>
          </div>
      ...
      <section className="w-full py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* Contact Form */}
            <div className="bg-[#E8F7FB] rounded-3xl p-8 lg:p-10">
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-white border-none focus:outline-none focus:ring-2 focus:ring-[#00A6CE] text-sm"
                    />
                  </div>
                  <div>
                    <label className="block text-gray-700 text-sm font-medium mb-2">
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    rows="6"
                    className="w-full px-4 py-3 rounded-lg bg-white border-none focus:outline-none focus:ring-2 focus:ring-[#00A6CE] text-sm resize-none"
                  />
                </div>
            ...
            <div className="bg-[#3D7A8A] rounded-3xl p-8 lg:p-10 text-white">
              ...
              <div className="space-y-6 mb-10">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm">1-800-478-4400</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm">hello@dukeconsultancy.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-sm">Mon–Sun: 9 AM–5PM</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-white rounded-full flex items-center justify-center hover:bg-gray-100 transition-colors">
                  <svg className="w-5 h-5 text-[#3D7A8A]" fill="currentColor" viewBox="0 0 24 24">
